...
import { registerPipelineTools } from './pipeline/mcp-tools.mjs';
...
/** Register the Delta Mode v0.1 and Pipeline Mode v0.2 tool contracts. */
export function createAcceleratorMcpServer({ fileDeltaService, commandDeltaService, pipelineService, sessionManager, rawOutputStore, version = '0.2.0' }) {
